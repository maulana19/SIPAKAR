    ...
    <div class="modal fade" id="addComponentModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" wire:submit.prevent='onSubmitComponent'>
        ...
        <table class="table">
            ...
            <tbody>
                @if ($dataKomponen != null)
                    @foreach ($dataKomponen as $key => $komponen)
                        <tr>
                            <td>
                            ...
                            <td>
                                <center>
                                <form wire:submit.prevent="deleteComponentItem($event.target.elements.inputField.value)">
                                    <input type="hidden" value="{{ Crypt::encrypt($komponen['kode_komponen']); }}" name="inputField" >
                ...
                <tr>
                    <td colspan="7">
                        <center>Data Komponen Item Tidak Ditemukan</center>
                    </td>
                </tr>
                @endif
            </tbody>
